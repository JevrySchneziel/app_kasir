                          ...
                          <div class="">
                              <div class="main-menu-header">
                                  ...
                                  <div class="user-details">
                                      <span id="more-details">Jepray<i class="fa fa-caret-down"></i></span>
                                  </div>
                              </div>
                                  ...
                                  <ul class="pcoded-submenu">
                                      ...
                                      <li class=" ">
                                          <a href="/pelanggan" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Pelanggan</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <!-- <li class=" ">
                                          <a href="button.html" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Detail Penjualan</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li> -->
                                      <li class=" ">
                                          <a href="/penjualan" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Penjualan</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <li class=" ">
